...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table class="table table-hover table-striped table-bordered" id="tbl-list">
            ...
            <tbody>
                <?php 
                $sql = "SELECT o.*, CONCAT(o.lastname, ', ', o.firstname, ', ', o.middlename) as fullname, p.position FROM official_list o inner join `position_list` p on o.position_id = p.position_id order by `fullname` asc";
                $qry = $conn->query($sql);
                $i = 1;
...
<script>
    ...
    $(function(){
        ...
        dtable = $('#tbl-list').dataTable({
            ...
            language: {
                emptyTable: "No appointed officials recorded yet."
            }
        })
